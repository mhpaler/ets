    ...
    <div className={styles.terminal}>
      <Typewriter
        ...
        onInit={(typewriter) => {
          ...
          .pasteString('-H <span style="color: orange;">\'Content-type: application/json; charset=utf-8\'</span> \\')
          .pasteString('<br/>')
          .pasteString('--data <span style="color: orange;">\'{ "tag": "#3dAnimation", "targetType": "nft-evm", "targetURI": "0x8ee9a60cb5c0e7db414031856cb9e0f1f05988d1|3061|1" }\'</span>')
          .pauseFor(1000)
          .pasteString('<br/>')
          .changeDelay(500)
          .pauseFor(500)
          ...
          .deleteChars(3)
          .pasteString('<br/>')
          .pasteString('#3dAnimation minted by 0x9a37...5c94 via 0x9a37...5c94')
          .pasteString('<br/>')
          .pauseFor(250)
          .pasteString('target 0932001...(nft-evm) tagged with #3dAnimation by 0x9a37...5c94 via 0x9a37...5c94')
          .pasteString('<br/>')
          .pasteString('<strong>$: </strong>')
          .pauseFor(4500)
