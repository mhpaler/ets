...
const { getInitSettings, getArtifacts } = require("./../setup.js");
...
contract("ERC721", function (accounts) {
  ...
  await this.accessControls.grantRole(
    await this.accessControls.DEFAULT_ADMIN_ROLE(),
    ETSPlatform
  );
  ...
  await this.accessControls.setRoleAdmin(
    ethers.utils.id("PUBLISHER"),
