...
let accounts, factories, ETSAccessControls, ETSPublisherControls, ETSLifeCycleControls, ETS;
...
describe("ETS publisher tests", function () {
  ...
  beforeEach("Setup test", async function () {
    ...
    await ETSPublisherControls.setETS(ETS.address);
