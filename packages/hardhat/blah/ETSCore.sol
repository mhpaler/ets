 ...
 */
contract ETSCore is Initializable, ContextUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    mapping(bytes16 => address) public targetType; // targetType => contract address
    mapping(uint256 => Target) public target; // _targetURI => Target
    ...
    function tag(
        ...
        // here we could run some simple string validation on the _type and _target
        require(kernel.validateTargetURI(_type,_targetURI), "Target URI not structued correctly.");
