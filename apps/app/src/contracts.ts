 ...
 */
export function getEts(config: Omit<GetContractArgs, 'abi' | 'address'>) {
  return getContract({ abi: etsABI, address: etsAddress, ...config })
}
...
export function writeEts<TFunctionName extends string>(
  config:
    | Omit<
        WriteContractPreparedArgs<typeof etsABI, TFunctionName>,
        'abi' | 'address'
      >
    | Omit<
        WriteContractUnpreparedArgs<typeof etsABI, TFunctionName>,
        'abi' | 'address'
      >,
) {
...
>(
  ...
  return watchContractEvent(
    { abi: etsABI, address: etsAddress, ...config } as WatchContractEventConfig<
      TAbi,
      TEventName
    >,
    callback,
 ...
 */
export function getEtsAccessControls(
 ...
 */
export function getEtsAuctionHouse(
  config: Omit<GetContractArgs, 'abi' | 'address'>,
) {
  return getContract({
    abi: etsAuctionHouseABI,
 ...
 */
export function getEtsEnrichTarget(
  config: Omit<GetContractArgs, 'abi' | 'address'>,
) {
  return getContract({
    abi: etsEnrichTargetABI,
 ...
 */
export function getEtsRelayerFactory(
  config: Omit<GetContractArgs, 'abi' | 'address'>,
) {
  return getContract({
    abi: etsRelayerFactoryABI,
 ...
 */
export function getEtsRelayerV1(
  config: Omit<GetContractArgs, 'abi' | 'address'>,
) {
  return getContract({
    abi: etsRelayerV1ABI,
 ...
 */
export function getEtsTarget(config: Omit<GetContractArgs, 'abi' | 'address'>) {
  return getContract({
    abi: etsTargetABI,
    address: etsTargetAddress,
    ...config,
...
export function writeEtsTarget<TFunctionName extends string>(
  config:
    | Omit<
        WriteContractPreparedArgs<typeof etsTargetABI, TFunctionName>,
        'abi' | 'address'
      >
    | Omit<
 ...
 */
export function getEtsToken(config: Omit<GetContractArgs, 'abi' | 'address'>) {
  return getContract({ abi: etsTokenABI, address: etsTokenAddress, ...config })
}
...
export function writeEtsToken<TFunctionName extends string>(
  config:
    | Omit<
        WriteContractPreparedArgs<typeof etsTokenABI, TFunctionName>,
        'abi' | 'address'
      >
    | Omit<
