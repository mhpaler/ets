    ...
    <footer className="px-4">
      <div className="max-w-7xl py-12 mx-auto md:flex md:items-center md:justify-between">
        <div className="flex justify-center space-x-6 md:order-2">
          <a href="https://github.com/ethereum-tag-service/ets" className="text-slate-400 hover:text-slate-500">
          ...
          <a href="https://twitter.com/etsxyz" className="text-slate-400 hover:text-slate-500">
            <span className="sr-only"></span>
            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
