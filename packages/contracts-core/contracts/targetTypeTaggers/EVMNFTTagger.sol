...
/// @dev UUPS upgradable.
contract EVMNFTTagger is IETSTargetTypeTagger, TargetTypeSignatureModule, Ownable, Pausable {
    ...
    function tag(TaggingRecordParams[] calldata _taggingRecords, address calldata _publisher) external payable {
