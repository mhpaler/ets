...
/// @title ETS EVMNFTMock Target Type Tagger Contract
/// @author Ethereum Tag Service <security@ets.xyz>
/// @notice Testing contract that moderates tagging of EVM compatible NFTs
/// on the ETS platform.
/// @dev Contract is for testing purposes only. Do not deploy to production
/// or enable as a target type.
contract EVMNFTMock is IETSTargetType, OwnableUpgradeable, UUPSUpgradeable, PausableUpgradeable {

    /// @notice EVMNFTMock Target Type tagging record input structure.
    /// When tagging an EVM compatible NFT on ETS, the EVMNFTMock Target Type
    ...
    /// ETS Core. A "tagging record" here is an EVMNFTMock target tagged with one
    ...
    /// @param _tagger address of tagger.
    /// @param _publisher address of publisher.
    function tag(
    ...
    function composeTargetURI(
        ...
        // ETS Ensure targetURI boilerplate format for EVMNFTMock is contract address|token id|chain id
