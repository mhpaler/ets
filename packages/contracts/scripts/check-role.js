...
async function checkRole() {
  const ETSAccessControls = await ethers.getContractAt('ETSAccessControls', '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512');
...
checkRole().then(() => process.exit(0)).catch((error) => { 
  console.error(error); 
  process.exit(1); 
});