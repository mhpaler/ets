...
abstract contract ChannelMock is ERC165, IETSChannel, Ownable, Pausable {
    ...
    string public constant NAME = "ChannelMock";
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IETSChannel) returns (bool) {
        return interfaceId == IID_IETSCHANNEL || super.supportsInterface(interfaceId);
    }

    function isPaused() public view returns (bool) {}

    function getChannelName() public pure returns (string memory) {
        return NAME;
    }
