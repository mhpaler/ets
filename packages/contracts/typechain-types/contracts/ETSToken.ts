...
export interface ETSTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "NAME"
      | "approve"
...
export interface ETSToken extends BaseContract {
  connect(runner?: ContractRunner | null): ETSToken;
  waitForDeployment(): Promise<this>;

  interface: ETSTokenInterface;
