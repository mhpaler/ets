import { Creator, Owner, Platform, Relayer, Tagger } from "../generated/schema";
...
/*
 * Safely loads (and initialises if needed) an Relayer entity
 *
 * id identifer; in this case the Ethereum account
 */
export function safeLoadRelayer(id: string): Relayer | null {
  let entity = Relayer.load(id);

  if (entity === null) {
    entity = new Relayer(id);
    entity.mintCount = ZERO;
    entity.tagCount = ZERO;
    entity.tagFees = ZERO;
  }
