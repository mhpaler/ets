...
export interface ETSAccessControlsInterface extends utils.Interface {
  functions: {
...
export interface ETSAccessControls extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETSAccessControlsInterface;
