    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
        ...
        <div className="space-y-4">
          <Link
            href={isLocalhost ? "http://arbitrumsepolia.localhost:3001" : "https://app.arbitrumsepolia.ets.xyz"}
            className="block w-full py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 text-center"
          >
            Arbitrum Sepolia
          </Link>
          <Link
            href={isLocalhost ? "http://basesepolia.localhost:3001" : "https://app.basesepolia.ets.xyz"}
          ...
          {isLocalhost && (
            <Link
              href="http://hardhat.localhost:3001"
