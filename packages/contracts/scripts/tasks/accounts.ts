...
const accountsTask = task("accounts", "Prints the list of accounts with balances");

if (accountsTask.addOptionalParam) {
  accountsTask.addOptionalParam("count", "Number of accounts to display", "11");
}

accountsTask.setAction(async (taskArgs, hre) => {
  console.log("====================================");
