...
export class RelayerMock__factory extends ContractFactory {
  ...
  override attach(address: string): RelayerMock {
    return super.attach(address) as RelayerMock;
  }
  override connect(signer: Signer): RelayerMock__factory {
    return super.connect(signer) as RelayerMock__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): RelayerMockInterface {
    return new utils.Interface(_abi) as RelayerMockInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RelayerMock {
    return new Contract(address, _abi, signerOrProvider) as RelayerMock;
  }
}
